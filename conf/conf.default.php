...
return array(
    ...
    'view_url' => 'https://cdn.jsdelivr.net/gh/yalage/dadaoge@1.0/view/',        // 可以配置单独 CDN 域名：比如：http://static.domain.com/view/
    'upload_url' => 'upload/',    // 本地文件上传目录，
    'upload_path' => '/data/wwwroot/static.officearm.com/upload/',    // 物理路径，可以用 NFS 存入到单独的文件服务器
    'upload_quick' => 0,  // 文件秒传 0关闭 1开启
    'attach_on' => 1,     // 0本地储存 1云储存 2图床
    'attach_delete' => 1, // 开启云储存后本地附件 0不删除 1删除
    'cloud_url' => 'https://static.officearm.com/',    // 云储存域名或单独CDN域名，本地upload目录和目录下的文件上传至云储存，域名绑定的目录必须对应程序的upload，如http://upload.domain.com/upload/thumbnail/201912/***.jpg
    'path' => './', // 前台路径 "/" 结尾
